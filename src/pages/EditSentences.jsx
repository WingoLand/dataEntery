...
//     setId(sentence._id);
//     setSent1(sentence.sent1);
//     setSent2(sentence.sent2);
//     setChoices(sentence.choices);
//     setCorrectChoice(sentence.correct);
//     setArabicSentences(sentence.arabicSents);
//     setCorrectArabicSent(sentence.correctArabicSent);
//   };
...
//     fetch(`${BASE_URL}/sentence/updateSentence`, {
//       method: "PUT",
//       headers: {
...
//                 sentenceItem.sent1 +
//                 " " +
//                 sentenceItem.choices[sentenceItem.correct] +
//                 " " +
//                 sentenceItem.sent2
//               )
//                 .toLowerCase()
...
//             )
//             .map((sentenceItem) => (
//               <Col xs={6} sm={4} md={3} lg={2} key={sentenceItem._id}>
//                 <Card
...
//                   }
//                   onClick={() => handleEditClick(sentenceItem)}
//                 >
//                   <Card.Body>
